...
export const TabletDetails = ({ tablets }) => {
  ...
  const [selectedColor, setSelectedColor] = useState(tablet?.color);
  const [selectedCapacity, setSelectedCapacity] = useState(tablet?.capacity);
  const [selectedImage, setSelectedImage] = useState(tablet?.images[0]);
